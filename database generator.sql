...
-- Mon 26 Feb 2018 02:50:22 AM MST
...
-- Schema ALEXAMARA
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ALEXAMARA` DEFAULT CHARACTER SET latin1 ;
-- -----------------------------------------------------
...
-- Schema HENRY
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `HENRY` DEFAULT CHARACTER SET latin1 ;
-- -----------------------------------------------------
-- Schema hr
-- -----------------------------------------------------
...
-- Schema PREMIERE
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `PREMIERE` DEFAULT CHARACTER SET latin1 ;
-- -----------------------------------------------------
-- Schema sakila
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `ALEXAMARA`.`MARINA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ALEXAMARA`.`MARINA` (
  `MARINA_NUM` CHAR(4) NOT NULL,
  `NAME` CHAR(20) NULL DEFAULT NULL,
  `ADDRESS` CHAR(15) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `ALEXAMARA`.`MARINA_SLIP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ALEXAMARA`.`MARINA_SLIP` (
  `SLIP_ID` DECIMAL(4,0) NOT NULL,
  `MARINA_NUM` CHAR(4) NULL DEFAULT NULL,
  `SLIP_NUM` CHAR(4) NULL DEFAULT NULL,
  `LENGTH` DECIMAL(4,0) NULL DEFAULT NULL,
  `RENTAL_FEE` DECIMAL(8,2) NULL DEFAULT NULL,
  `BOAT_NAME` CHAR(50) NULL DEFAULT NULL,
  `BOAT_TYPE` CHAR(50) NULL DEFAULT NULL,
  `OWNER_NUM` CHAR(4) NULL DEFAULT NULL,
  PRIMARY KEY (`SLIP_ID`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `ALEXAMARA`.`OWNER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ALEXAMARA`.`OWNER` (
...
-- -----------------------------------------------------
-- Table `ALEXAMARA`.`SERVICE_CATEGORY`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ALEXAMARA`.`SERVICE_CATEGORY` (
  `CATEGORY_NUM` DECIMAL(4,0) NOT NULL,
  `CATEGORY_DESCRIPTION` CHAR(255) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `ALEXAMARA`.`SERVICE_REQUEST`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ALEXAMARA`.`SERVICE_REQUEST` (
  `SERVICE_ID` DECIMAL(4,0) NOT NULL,
  `SLIP_ID` DECIMAL(4,0) NULL DEFAULT NULL,
  `CATEGORY_NUM` DECIMAL(4,0) NULL DEFAULT NULL,
  `DESCRIPTION` CHAR(255) NULL DEFAULT NULL,
  `STATUS` CHAR(255) NULL DEFAULT NULL,
  `EST_HOURS` DECIMAL(4,2) NULL DEFAULT NULL,
  `SPENT_HOURS` DECIMAL(4,2) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `classicmodels`.`employees` (
  ...
  INDEX `officeCode` (`officeCode` ASC),
...
CREATE TABLE IF NOT EXISTS `classicmodels`.`customers` (
  ...
  INDEX `salesRepEmployeeNumber` (`salesRepEmployeeNumber` ASC),
...
CREATE TABLE IF NOT EXISTS `classicmodels`.`orders` (
  ...
  INDEX `customerNumber` (`customerNumber` ASC),
...
CREATE TABLE IF NOT EXISTS `classicmodels`.`products` (
  ...
  INDEX `productLine` (`productLine` ASC),
...
-- Table `HENRY`.`AUTHOR`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `HENRY`.`AUTHOR` (
  `AUTHOR_NUM` DECIMAL(2,0) NOT NULL,
  `AUTHOR_LAST` CHAR(12) NULL DEFAULT NULL,
  `AUTHOR_FIRST` CHAR(10) NULL DEFAULT NULL,
...
-- Table `HENRY`.`BOOK`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `HENRY`.`BOOK` (
  `BOOK_CODE` CHAR(4) NOT NULL,
  `TITLE` CHAR(40) NULL DEFAULT NULL,
  `PUBLISHER_CODE` CHAR(3) NULL DEFAULT NULL,
  `TYPE` CHAR(3) NULL DEFAULT NULL,
  `PRICE` DECIMAL(4,2) NULL DEFAULT NULL,
  `PAPERBACK` CHAR(1) NULL DEFAULT NULL,
...
-- Table `HENRY`.`BRANCH`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `HENRY`.`BRANCH` (
  `BRANCH_NUM` DECIMAL(2,0) NOT NULL,
  `BRANCH_NAME` CHAR(50) NULL DEFAULT NULL,
  `BRANCH_LOCATION` CHAR(50) NULL DEFAULT NULL,
  `NUM_EMPLOYEES` DECIMAL(2,0) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `HENRY`.`INVENTORY`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `HENRY`.`INVENTORY` (
  `BOOK_CODE` CHAR(4) NOT NULL,
  `BRANCH_NUM` DECIMAL(2,0) NOT NULL,
  `ON_HAND` DECIMAL(2,0) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `HENRY`.`PUBLISHER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `HENRY`.`PUBLISHER` (
  `PUBLISHER_CODE` CHAR(3) NOT NULL,
  `PUBLISHER_NAME` CHAR(25) NULL DEFAULT NULL,
...
-- Table `HENRY`.`WROTE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `HENRY`.`WROTE` (
  `BOOK_CODE` CHAR(4) NOT NULL,
  `AUTHOR_NUM` DECIMAL(2,0) NOT NULL,
  `SEQUENCE` DECIMAL(1,0) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hr`.`countries` (
  ...
  INDEX `COUNTR_REG_FK` (`REGION_ID` ASC))
ENGINE = MyISAM
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `hr`.`departments` (
  ...
  INDEX `DEPT_MGR_FK` (`MANAGER_ID` ASC),
...
CREATE TABLE IF NOT EXISTS `hr`.`employees` (
  ...
  UNIQUE INDEX `EMP_EMAIL_UK` (`EMAIL` ASC),
...
CREATE TABLE IF NOT EXISTS `hr`.`locations` (
  ...
  `COUNTRY_ID` VARCHAR(2) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hr`.`regions` (
  ...
  UNIQUE INDEX `sss` (`REGION_NAME` ASC))
ENGINE = MyISAM
DEFAULT CHARACTER SET = latin1;
...
CREATE TABLE IF NOT EXISTS `northwind`.`CustomerCustomerDemo` (
  ...
  INDEX `FK_CustomerCustomerDemo` (`CustomerTypeID` ASC),
...
CREATE TABLE IF NOT EXISTS `northwind`.`EmployeeTerritories` (
  ...
  INDEX `FK_EmployeeTerritories_Territories` (`TerritoryID` ASC),
...
CREATE TABLE IF NOT EXISTS `northwind`.`Orders` (
  ...
  INDEX `FK_Orders_Customers` (`CustomerID` ASC),
  INDEX `FK_Orders_Employees` (`EmployeeID` ASC),
  INDEX `FK_Orders_Shippers` (`ShipVia` ASC),
...
CREATE TABLE IF NOT EXISTS `northwind`.`Products` (
  ...
  INDEX `FK_Products_Categories` (`CategoryID` ASC),
  INDEX `FK_Products_Suppliers` (`SupplierID` ASC),
...
CREATE TABLE IF NOT EXISTS `northwind`.`OrderDetails` (
  ...
  INDEX `FK_Order_Details_Products` (`ProductID` ASC),
...
-- -----------------------------------------------------
-- Table `PREMIERE`.`CUSTOMER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PREMIERE`.`CUSTOMER` (
  `CUSTOMER_NUM` CHAR(3) NOT NULL,
  `CUSTOMER_NAME` CHAR(35) NOT NULL,
  `STREET` CHAR(15) NULL DEFAULT NULL,
  `CITY` CHAR(15) NULL DEFAULT NULL,
  `STATE` CHAR(2) NULL DEFAULT NULL,
  `ZIP` CHAR(5) NULL DEFAULT NULL,
  `BALANCE` DECIMAL(8,2) NULL DEFAULT NULL,
  `CREDIT_LIMIT` DECIMAL(8,2) NULL DEFAULT NULL,
  `REP_NUM` CHAR(2) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `PREMIERE`.`ORDERS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PREMIERE`.`ORDERS` (
  `ORDER_NUM` CHAR(5) NOT NULL,
  `ORDER_DATE` DATE NULL DEFAULT NULL,
  `CUSTOMER_NUM` CHAR(3) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `PREMIERE`.`ORDER_LINE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PREMIERE`.`ORDER_LINE` (
  `ORDER_NUM` CHAR(5) NOT NULL,
  `PART_NUM` CHAR(4) NOT NULL,
  `NUM_ORDERED` DECIMAL(3,0) NULL DEFAULT NULL,
  `QUOTED_PRICE` DECIMAL(6,2) NULL DEFAULT NULL,
...
-- Table `PREMIERE`.`PART`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PREMIERE`.`PART` (
  `PART_NUM` CHAR(4) NOT NULL,
  `DESCRIPTION` CHAR(15) NULL DEFAULT NULL,
  `ON_HAND` DECIMAL(4,0) NULL DEFAULT NULL,
  `CLASS` CHAR(2) NULL DEFAULT NULL,
  `WAREHOUSE` CHAR(1) NULL DEFAULT NULL,
...
-- Table `PREMIERE`.`REP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `PREMIERE`.`REP` (
  `REP_NUM` CHAR(2) NOT NULL,
  `LAST_NAME` CHAR(15) NULL DEFAULT NULL,
  `FIRST_NAME` CHAR(15) NULL DEFAULT NULL,
  `STREET` CHAR(15) NULL DEFAULT NULL,
  `CITY` CHAR(15) NULL DEFAULT NULL,
  `STATE` CHAR(2) NULL DEFAULT NULL,
  `ZIP` CHAR(5) NULL DEFAULT NULL,
  `COMMISSION` DECIMAL(7,2) NULL DEFAULT NULL,
...
USE `sys`;
CREATE  OR REPLACE ALGORITHM=UNDEFINED DEFINER=`mysql.sys`@`localhost` SQL SECURITY INVOKER VIEW `sys`.`version` AS select '1.5.0' AS `sys_version`,version() AS `mysql_version`;
